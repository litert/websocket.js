[Documents for @litert/websocket](../../index.md) / [Errors](../index.md) / E\_CONN\_READONLY

# Class: E\_CONN\_READONLY

Defined in: [src/lib/Errors.ts:60](https://github.com/litert/websocket.js/blob/master/src/lib/Errors.ts#L60)
...
> **new E\_CONN\_READONLY**(`context`, `origin`): `E_CONN_READONLY`

Defined in: [src/lib/Errors.ts:62](https://github.com/litert/websocket.js/blob/master/src/lib/Errors.ts#L62)
